...
public class Artiste {
    ...
    private Type_De_Musique Type_De_Musique;
    ...
    public Type_De_Musique getType_De_Musique() {
        return Type_De_Musique;
    }

    public void setType_De_Musique(Type_De_Musique Type_De_Musique) {
    ...
    public Artiste(String Nom_Artiste, Type_De_Musique Type_De_Musique) {
        this.Nom_Artiste = Nom_Artiste;
        this.Type_De_Musique = Type_De_Musique;
    }

    public Artiste(int Id_Artiste, String Nom_Artiste, Type_De_Musique Type_De_Musique) {
        this.Id_Artiste = Id_Artiste;
        this.Nom_Artiste = Nom_Artiste;
        this.Type_De_Musique = Type_De_Musique;
    }
