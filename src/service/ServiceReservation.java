...
public class ServiceReservation  {
    ...
    public void Ajouter(Reservation t) {
        ...
        PreparedStatement pst =new DataSources().cnx.prepareStatement(requete);
   ...
   public void e_bookPDF() throws FileNotFoundException, DocumentException, MalformedURLException, IOException {
        ...
        PdfWriter.getInstance(document, new FileOutputStream(new File("C:\\Users\\TECHNOPC\\Desktop\\seif w youssef w chams 1\\seif and youssef\\PIDEVAPP\\ReservationPDF.pdf")));
        document.open();
